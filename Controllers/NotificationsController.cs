...
namespace TheBugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectId,TicketId,Title,Message,Created,SenderId,RecipientId,NotificationTypeId,HasBeenReviewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProjectId,TicketId,Title,Message,Created,SenderId,RecipientId,NotificationTypeId,HasBeenReviewed")] Notification notification)
        {
