...
namespace TheBugTracker.Services
{
    public class BTFileService : IBTFileService
    {
        ...
        private readonly string _defaultBTUserImageSrc = "/img/defaultuser.png";
        private readonly string _defaultCompanyImageSrc = "/img/defaultuser.png";
        private readonly string _defaultProjectImageSrc = "/img/sample.png";
        #endregion
