...
namespace TheBugTracker.Data.Migrations
{
    ...
    [Migration("20230907184334_Initial_001")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheBugTracker.Models.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TheBugTracker.Models.Notification", b =>
                {
                    b.HasOne("TheBugTracker.Models.NotificationType", "NotificationType")
                        .WithMany()
            ...
            modelBuilder.Entity("TheBugTracker.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("TheBugTracker.Models.BTUser", "SubmitterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TheBugTracker.Models.TicketAttachment", b =>
                {
                    b.HasOne("TheBugTracker.Models.BTUser", "BTUser")
                        .WithMany()
